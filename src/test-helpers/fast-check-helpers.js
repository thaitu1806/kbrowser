...
exports.FC_DEFAULT_PARAMS = void 0;
 ...
 */
function propertyTag(number, text) {
 ...
 */
async function assertProperty(property, params) {
    await fc.assert(property, { ...exports.FC_DEFAULT_PARAMS, ...params });
}
//# sourceMappingURL=fast-check-helpers.js.map