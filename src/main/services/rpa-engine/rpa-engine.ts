...
const BUILT_IN_TEMPLATES: Array<{
  ...
  },
  {
    ...
    actions: [
      { type: 'accessWebsite', value: 'https://www.amazon.com' },
      { type: 'click', selector: '#twotabsearchtextbox' },
      { type: 'input', selector: '#twotabsearchtextbox', value: '{{search_term}}' },
  ...
  },
  {
    ...
    actions: [
      { type: 'accessWebsite', value: 'https://www.tiktok.com' },
      { type: 'waitTime', timeout: 3000 },
